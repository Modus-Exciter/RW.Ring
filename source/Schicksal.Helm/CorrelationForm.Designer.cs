namespace Schicksal.Helm
{
  partial class CorrelationForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      // m_label_metrics1
      // 
      resources.ApplyResources(this.m_label_metrics1, "m_label_metrics1");
      this.m_label_metrics1.BackColor = System.Drawing.Color.White;
      ...
      this.m_bottom_panel.Controls.Add(this.m_label_metrics1, 0, 0);
      this.m_bottom_panel.Controls.Add(this.m_label_metrics2, 0, 1);
      this.m_bottom_panel.Name = "m_bottom_panel";
      // 
      // m_label_metrics2
      // 
      resources.ApplyResources(this.m_label_metrics2, "m_label_metrics2");
      this.m_label_metrics2.BackColor = System.Drawing.Color.Transparent;
