namespace Schicksal.Helm.Dialogs
{
  partial class StatisticsParametersDialog
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.m_options_panel = new System.Windows.Forms.Panel();
      this.m_label_probability = new System.Windows.Forms.Label();
      this.m_options_button = new System.Windows.Forms.Button();
      ...
      this.m_options_panel.SuspendLayout();
      ...
      // m_binding_source
      // 
      this.m_binding_source.DataSource = typeof(Schicksal.Helm.Dialogs.StatisticsParameters);
      // 
      // m_table_panel
      // 
      ...
      this.m_table_panel.Controls.Add(this.m_options_panel, 0, 4);
      ...
      // m_options_panel
      // 
      this.m_table_panel.SetColumnSpan(this.m_options_panel, 2);
      this.m_options_panel.Controls.Add(this.m_label_probability);
      this.m_options_panel.Controls.Add(this.m_options_button);
      resources.ApplyResources(this.m_options_panel, "m_options_panel");
      this.m_options_panel.Name = "m_options_panel";
      // 
      // m_label_probability
      // 
      ...
      this.m_options_panel.ResumeLayout(false);
      this.m_options_panel.PerformLayout();
    ...
    private System.Windows.Forms.Panel m_options_panel;
    private System.Windows.Forms.Button m_options_button;
  }
}