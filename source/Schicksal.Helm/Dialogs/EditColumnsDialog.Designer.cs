namespace Schicksal.Helm.Dialogs
{
  partial class EditColumnsDialog
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.m_bottom_panel = new System.Windows.Forms.Panel();
      ...
      this.m_layout_panel.Controls.Add(this.m_button_cancel);
      this.m_layout_panel.Controls.Add(this.m_button_ok);
      ...
      this.m_bottom_panel.Controls.Add(this.m_layout_panel);
      this.m_bottom_panel.Controls.Add(this.m_button_delete);
      this.m_bottom_panel.Name = "m_bottom_panel";
      // 
      // m_button_delete
      // 
      resources.ApplyResources(this.m_button_delete, "m_button_delete");
      this.m_button_delete.Image = global::Schicksal.Helm.Properties.Resources.delete2;
    ...
    private System.Windows.Forms.Panel m_bottom_panel;
