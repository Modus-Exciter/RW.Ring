...
namespace NotungTest
{
  ...
  public class CommonTest
  {
    ...
    public void SpearmanRanksTest()
    {
      ...
      var spear = RankNormalizer.CalculateRanks(nums, -1);
     // for
      Assert.AreEqual(1, spear[1.1]);
      Assert.AreEqual(2, spear[6]);
      Assert.AreEqual(3, spear[8.7]);
      Assert.AreEqual(4, spear[9.5]);
      Assert.AreEqual(5, spear[12]);
    }
    ...
    public void SpearmanRanksTestWithDuplicates()
    {
      ...
      Assert.AreEqual(5, spear[6]);
      Assert.AreEqual(6, spear[8.7]);
      Assert.AreEqual(7, spear[9.5]);
      Assert.AreEqual(8.5f, spear[12]);
    }
  }
}